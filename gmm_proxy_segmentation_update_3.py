...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        type=int,
        default=3,
        help="Minimum number of GMM components to try. Default 3 to target low/mid/high bands.",
    )
    p.add_argument(
        "--max-components",
        type=int,
        default=3,
        help="Maximum number of GMM components to try. Default 3 to target low/mid/high bands.",
    )
    p.add_argument(
        "--grid-points",
        type=int,
